#Title: SportsZone
###Group Members: Andony Velasquez Carrillo, Kevin Yao (kyao11), Ulises Reyes (ureyes2), Daniel Arutti
...
Functional Requirements: 2 people
Suggested Features (5 minimum)
...
Original Features (2 minimum)
Account making and age verification (ask user to verify age)
Use cases:
Basic Flow: user is able to create an account with real age
Alternative Flow: user creates an account with a fake age
Exception Flow: user is unable to create an account due to age verification
Track past activities (see history of locations, people who participated)
Use cases: 
Basic Flow: user checks history of past activities and asks past group members if they want to play again.
Alternative Flow: user only checks history without contacting past group members
Exception Flow: user doesn’t check past activities
